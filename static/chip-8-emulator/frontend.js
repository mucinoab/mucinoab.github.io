...
export class Emulator {
    ...
    */
    keypress(evt, pressed) {
        wasm.emulator_keypress(this.__wbg_ptr, addHeapObject(evt), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_game(data) {
        wasm.emulator_load_game(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    */
    reset() {
    ...
    */
    draw_screen(scale) {
        wasm.emulator_draw_screen(this.__wbg_ptr, scale);
    }
}
